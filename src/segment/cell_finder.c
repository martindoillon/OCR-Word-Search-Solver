#include "cell_finder.h"   // declare the new function here
#include <SDL2/SDL.h>
...
#include "utils.h" // for make_dir_if_needed, draw_rect

// keep read_grid_roi and split_round here (or move to roi utils)
